...
### 🌐 Development & Design
<img src="https://skillicons.dev/icons?i=html,css,tailwind,javascript,typescript,react,nextjs,nodejs,figma" />

### 🤖 Artificial Intelligence & Data
<img src="https://skillicons.dev/icons?i=python,tensorflow,pytorch,mongodb,mysql,linux" />

### 🛠️ Tools & DevOps
<img src="https://skillicons.dev/icons?i=git,github,docker,vscode,aws,postman" />
...
```mermaid
graph TD
    A[Student Enrollment] --> B{Choose Specialization}
    B -->|AI Path| C[Fundamentals of Python & ML]
    B -->|Dev Path| D[Full Stack Mastery]
    C --> E[Capstone Project: AI Model]
    D --> E
    E --> F[Industry Internship]
    F --> G[Placement / Startup Launch]
    
    style G fill:#00F7FF,stroke:#000,stroke-width:2px,color:#000
